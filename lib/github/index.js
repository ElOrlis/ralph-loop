...
async function main() {
  ...
  switch (command) {
    ...
    default:
      ...
      console.error('Commands: resolve-repo, create-issue, update-issue, close-issue, create-project, ensure-project-item, sync-project-item, validate-project, repair-project-fields, ensure-pr, mark-pr-ready');
      process.exit(1);
  }
}
